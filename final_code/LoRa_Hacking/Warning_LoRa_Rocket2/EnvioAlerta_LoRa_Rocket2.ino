...
unsigned long frecuencias[] = { 865E6 , 865.7E6 , 866.05E6 , 866.4E6 , 876.75E6 };        //Rocket_02
...
void envia_lora() {  //Send LoRa packet to receiver
  LoRa.beginPacket();
  LoRa.print("¡ALERTA! Vuestros datos son vulnerables");
  LoRa.endPacket();
}
...
void envia_oled_exito() {
  ...
  display.println("VEGAS_TEAM_IESFGL");
